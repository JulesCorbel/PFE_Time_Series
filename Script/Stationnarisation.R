...
#Stationnarisation des variables
  ...
  MSEAnnStaStaTest <- window(MSEAnnSta, start=2016)
  ...
  plot(MSETrimSta)
  MSETrimStaStaTrain <- window(MSETrimSta, end=c(2015,4))
  MSETrimStaStaTest <- window(MSETrimSta, start=2016)
  ...
  PIBAnnStaStaTest <- window(PIBAnnSta, start=2016)
  ...
  plot(PIBTrimSta)
  PIBTrimStaTrain <- window(PIBTrimSta, start = 1992, end=c(2015,4))
  ...
  plot(SMICTrimSta)
  SMICTrimStaTrain <- window(SMICTrimSta, start = 1992, end=c(2015,4))
  ...
  plot(TCHOTrimSta)
  TCHOTrimStaTrain <- window(TCHOTrimSta, start = 1992, end=c(2015,4))
