...
#Stationnarisation des variables
  ...
  #MSE
  adf.test(MSEAnn)
  MSEAnnSta <- MSEAnn - window(ma(MSEAnn, order=5), start=1991, end=2016)
  acf(MSEAnnSta)
  pacf(MSEAnnSta)
  kpss.test(MSEAnnSta)
  plot(MSEAnnSta)
  ...
  adf.test(PIBAnn)
  PIBAnnSta <- PIBAnn - window(ma(PIBAnn, order=5), start=1991, end=2016)
  acf(PIBAnnSta)
  pacf(PIBAnnSta)
  kpss.test(PIBAnnSta)
  plot(PIBAnnSta)
  ...
  adf.test(SMICAnn)
  SMICAnnSta <- SMICAnn - window(ma(SMICAnn, order=5), start=1991, end=2016)
  acf(SMICAnnSta)
  pacf(SMICAnnSta)
  ...
  adf.test(TCHOAnn)
  TCHOAnnSta <- TCHOAnn - window(ma(TCHOAnn, order=5), start=1991, end=2016)
  acf(TCHOAnnSta)
  pacf(TCHOAnnSta)
  ...
  adf.test(AGEDAnn)
  AGEDAnnSta <- AGEDAnn - window(ma(AGEDAnn, order=5), start=1991, end=2016)
  acf(AGEDAnnSta)
  pacf(AGEDAnnSta)
