...
On se rend compte que le modèle avec l'AIC corrigé le plus faible est le modèle prenant en compte le SMIC. Nous nous intéressons donc à la prédiction de ce modèle (dans la \ref{fig14}).
