...
```{r}
  ...
  kpss.test(MSESta)
  adf.test(MSESta)
  MSETrendTest <- forecast(auto.arima(MSETrend), h=14)
...
A1stand<-cbind(summary(modele$varresult$MSESta)$coefficients[1:4,2], 
...
A2stand<-cbind(summary(modele$varresult$MSESta)$coefficients[5:8,2], 
...
A2
A3stand<-cbind(summary(modele$varresult$MSESta)$coefficients[9:12,2], 
...
A3
A4stand<-cbind(summary(modele$varresult$MSESta)$coefficients[13:16,2], 
